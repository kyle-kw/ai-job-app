...
for (const [path, ecosystem] of [['src-tauri/Cargo.lock', 'cargo'], ['sidecar/uv.lock', 'pypi']]) {
...
writeFileSync(output, `Generated from committed lockfiles; review with THIRD_PARTY_NOTICES.md.\n\n${rows.join('\n')}\n`, 'utf8');
