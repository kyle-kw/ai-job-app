pub const RESUME_EXTRACTION: &str = include_str!("../../skills/resume-extraction/SKILL.md");
pub const JOB_FIT: &str = include_str!("../../skills/job-fit/SKILL.md");
pub const GREETING_MESSAGE: &str = include_str!("../../skills/greeting-message/SKILL.md");
...
pub const REPORT_COMPETITIVENESS: &str =
    include_str!("../../skills/report-competitiveness/SKILL.md");
