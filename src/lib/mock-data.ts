...
export const mockResume: ResumeProfile = {
  ...
  professionalSkills: [
    { id: 'skills-core', label: '核心方向', items: ['LangChain', 'RAG'] },
    {
      id: 'skills-backend',
      label: '后端与数据',
      items: ['Python', 'FastAPI', 'PostgreSQL', 'Redis', 'TypeScript']
    },
  ...
  facts: [
    ...
    },
    {
      id: 'fact-agent',
      category: 'experience',
      value: '多 Agent 流程将处理时长从 20 分钟降到 6 分钟',
      source: '云帆科技经历第 2 条',
      confidence: 0.99,
      confirmed: true
    },
...
const baseJobs: Job[] = [
  {
    ...
    companyStage: 'D轮及以上',
    industry: '人工智能',
    skills: ['Python', 'LangChain', 'RAG', 'FastAPI', 'Docker'],
    welfare: ['五险一金', '带薪年假', '年度体检'],
    description:
      '负责企业级 AI Agent 平台研发，构建 RAG、工具调用和多 Agent 编排能力。要求熟练掌握 Python、FastAPI，有 LangChain 或类似框架经验，具备服务工程化与 Docker 部署经验。',
    sourceUrl: 'https://www.zhipin.com/job_detail/demo-a1.html',
    bossName: '陈女士',
    bossTitle: '招聘经理',
    firstSeen: now,
    lastSeen: now,
  ...
  },
  {
    ...
    companyStage: '已上市',
    industry: '互联网',
    skills: ['Python', 'RAG', 'Redis', 'PostgreSQL', 'Kubernetes'],
    welfare: ['年终奖', '五险一金', '零食下午茶'],
    description:
      '面向实时互动业务构建大模型应用，负责检索增强、评测体系与在线服务。熟悉 Python、向量检索和云原生部署，有复杂系统性能优化经验。',
    sourceUrl: 'https://www.zhipin.com/job_detail/demo-a2.html',
    bossName: '周女士',
    bossTitle: 'HRBP',
    firstSeen: now,
    lastSeen: now,
  ...
  },
  {
    ...
    companyStage: '天使轮',
    industry: '人工智能',
    skills: ['TypeScript', 'Svelte', 'Python', 'PostgreSQL', 'LLM'],
    welfare: ['股票期权', '补充医疗', '弹性工作'],
    description:
      '负责 AI 求职产品的全栈交付，从交互原型到模型能力接入。希望候选人能独立推进、快速验证并参与产品决策。',
    sourceUrl: 'https://www.zhipin.com/job_detail/demo-a3.html',
    bossName: '田先生',
    bossTitle: '创始人',
    firstSeen: now,
    lastSeen: now,
  ...
  },
  {
    ...
    companyStage: 'D轮及以上',
    industry: '金融科技',
    skills: ['Java', 'Kubernetes', 'Redis', 'MySQL', '微服务'],
    welfare: ['五险一金', '补充医疗', '年度奖金'],
    description:
      '建设大模型平台服务和网关体系，要求 5 年以上 Java 微服务经验，熟悉 Kubernetes、MySQL 和高并发系统。',
    sourceUrl: 'https://www.zhipin.com/job_detail/demo-a4.html',
    bossName: '王女士',
    bossTitle: '招聘专家',
    firstSeen: now,
    lastSeen: now,
  ...
  },
  {
    ...
    companyStage: 'B轮',
    industry: '人工智能',
    skills: ['Python', 'RAG', 'PyTorch', '向量数据库', 'NLP'],
    welfare: ['股票期权', '餐补', '补充医疗'],
    description:
      '研发企业级 RAG 算法和评测体系，负责召回、排序与数据闭环。要求硕士学历，具备 PyTorch 与 NLP 算法经验。',
    sourceUrl: 'https://www.zhipin.com/job_detail/demo-a5.html',
    bossName: '李先生',
    bossTitle: '技术招聘',
    firstSeen: now,
    lastSeen: now,
